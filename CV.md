...
parinporecha@gmail.com | +31 616912017 | [LinkedIn](https://www.linkedin.com/in/parinporecha) | [GitHub](https://github.com/parinporecha)

---

Senior engineer with 10+ years building products across big-tech scale, early-stage startups, and open source. I'm happiest in high-autonomy environments where I own a problem end-to-end - from shaping the roadmap and shipping fast to measuring what worked and iterating with users.
...
**Senior Software Engineer, Metasearch**

*Amsterdam, The Netherlands | April 2024 - Present | 2 years*

Technical lead on the Metasearch data platform, the backbone of Booking's ML-driven bidding for its metasearch channels. The platform built on Python, Perl (yes, still), Kubernetes, Airflow and Spark on GCP processes 700M+ rows/day across 300+ ETL pipelines.

- Own the platform's technical direction and cloud strategy through IaaC (Terraform) and paved-road patterns while keeping Security and FinOps in check.
...
- Established the team's code review, ownership, and incident response practices. Ran postmortems that led to real process improvements and helped team members grow in their careers.
...
*Bengaluru, India | December 2016 - May 2018 | 1 year 6 months*

Early engineer (#11) at a startup aggregating e-commerce product data across retailers.

- Owned data quality end-to-end: designed and shipped systems to detect miscategorized products, fix incorrect merges, and automatically reconcile data, directly improving the accuracy of the core product customers paid for.
- Collaborated with ML scientists on feature extraction and dataset preparation for product matching models; built jobs to compute signals, clean labels, and validate training data.
- Built and managed annotation pipelines using Amazon Mechanical Turk to generate labeled datasets for product matching and categorization models.
- Built monitoring and alerting tooling to catch data integrity issues before they propagated to downstream consumers.
...
*Bengaluru, India | July 2015 - December 2016 | 1 year 6 months*
...
- Developed real-time and historic traffic models powering dynamic routing for last-mile delivery, improving ETA accuracy for end users.



## Open Source & Earlier Work

* **GNOME Foundation - Open Source Developer & Maintainer** *2013-2015*

Maintained GNOME-Sudoku and Getting Things GNOME! (a personal tasks organizer for the GNOME desktop environment) - releases, patch reviews, bug triage, and onboarding new contributors. Also contributed to PulseAudio, a cross-platform sound server. Mentored a student through GNOME's Outreach Program for Women: helped her navigate the community, scoped milestones, reviewed code, and guided her through her first upstream contributions.

* **CERN - Software Intern** *Geneva, Switzerland | Summer 2014*
...
My passion project: Building a narrative-driven audio+board game about the Amsterdam housing crisis, seen through the eyes of a cult leader and law enforcement.

* **KDV De Krakeling** *Feb 2026 - present*

Working at a parent-participation daycare where parents actively shape operations and take turns looking after the kids. Also part of the committee shaping pedagogical policy based on the Gordon method. The hardest part is trying not to come up with digital solutions for the analog problems here.
